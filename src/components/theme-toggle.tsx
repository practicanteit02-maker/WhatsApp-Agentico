...
export function ThemeToggle({
  ...
  className?: string;
  align?: 'left' | 'right';
  /** Hacia dónde se abre el menú de apariencia respecto al botón — 'bottom'
   * (por defecto, como siempre) o 'top' para cuando el botón vive pegado
   * abajo del todo (ej. el pie de la lista de chats) y abrirlo hacia abajo
   * lo cortaría contra el borde de la pantalla. */
    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div
          ...
          aria-label="Appearance"
          className={cn(
            'absolute z-50 w-56 rounded-lg border border-border bg-popover p-3 text-popover-foreground shadow-lg',
