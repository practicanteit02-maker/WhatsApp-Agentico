...
/**
 * Funcionalidad "RBAC": pantalla de Ajustes (números rastreados), exclusiva
 * de Administrador. Extraída como componente cliente aparte de
 * src/app/settings/page.tsx, que ahora es un server component que hace el
 * chequeo de perfil ANTES de renderizar esto — mismo patrón que
 * src/app/usuarios/page.tsx + UserManager.
 */
