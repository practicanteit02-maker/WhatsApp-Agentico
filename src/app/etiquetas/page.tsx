...
import { TagsCatalogManager } from '@/components/tags-catalog-manager';
      ...
      <header className="chat-header-on-brand sticky top-0 z-20 border-b border-[var(--chat-border-strong)] bg-[var(--chat-header)] px-4 py-3 safe-area-top">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="flex min-w-0 items-center gap-2">
              <Tags className="size-4 flex-shrink-0 text-[var(--chat-presence)]" />
              <h1 className="truncate text-base font-semibold text-foreground">Etiquetas</h1>
            </div>
          </div>
